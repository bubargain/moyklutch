			...
			<form action="admin.php?m=setting&a=ls" method="post">
				...
				<table class="opt">
					...
					<tr>
						...
						<td>	同一用户在 24 小时内可以发送的短消息的极限，建议在 300 - 1000 范围内取值，0 为不限制，此举为了限制通过机器批量发广告</td>
					</tr>
					<tr>
						<th colspan="2">同一用户在 24 小时最多允许发送短消息的最大用户数目:</th>
					</tr>
					<tr>
						<td><input type="text" class="txt" name="pmuserlimit1day" value="<?=$pmuserlimit1day?>" /></td>
						<td>	同一用户在 24 小时内可以发送短消息的用户数的极限，建议在 30 - 100 范围内取值，0 为不限制，此举为了限制通过机器批量发广告</td>
					</tr>
					<tr>
