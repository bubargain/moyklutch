...
document.writeln('<iframe id=endDateLayer frameborder=0 width=162 height=211 style="position: absolute;  z-index: 1; display: none"></iframe>');
strFrame='<style>';
...
function setday(tt,obj) //主调函数
{
	...
	var hlay=document.all.endDateLayer.clientHeight;
	// alert("ttop:hbody:thei==="+ttop+":"+hbody+":"+thei+":"+hlay);
	if(ttop+thei+211>hbody){
	   ttop-=211;
	   ttop-=thei;
	  //alert(ttop);
	}
