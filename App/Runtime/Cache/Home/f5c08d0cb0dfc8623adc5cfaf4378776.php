...
<div class="cr"></div>
	<div class="fl w71">
<div id="space">当前位置：<a href="__APP__">首页</a>&gt;商家详情&gt;<?php echo ($vo["title"]); ?></div>
	<h3><?php echo ($vo["title"]); ?></h3>
    <div class="sub-m">Time:<?php echo (toDate($vo["update_time"])); ?></div>
    <div id="body-m"><?php echo ($vo["introduce"]); ?></div>
<div class="cr"></div>
<div class="box5-title">此商家的所有优惠券</div>
<div class="box1">
<ul class="list1">
<?php $_result=D('Ticket')->getlist("where ticket.status=1 and ticket.close_time > 1317253995 and ticket.trade_id =$vo[id]",'','',''); if ($_result): $i=0;foreach($_result as $key=>$voo):++$i;$mod = ($i % 2 );?><li>
...
<p class="q-inf"><?php echo (t_substr($voo["title"],0,10)); ?></p>
<p class="q-pr"><a href="__GROUP__/User/ticket_col/id/<?php echo ($voo["id"]); ?>">加入收藏</a>|<a href="javascript:;" class="prt">立即打印</a></p>
</div>
...
<div class="cr"></div>
<div id="shop-c">
<?php  if(is_array($comment)): foreach($comment as $key=>$com): ?><p><span>—<?php echo (date("Y年m月d日:H i s",$com["create_time"])); ?></span>评论者：<?php echo (get_user($com["user_id"])); ?></p>
<div><?php echo ($com["content"]); ?></div><?php endforeach; endif; ?>
</div>
<div class="cr"></div>
<div id="fpage">
<?php echo ($page); ?>
...
<?php if(($config_list == 1)): ?>

<form method="post" action="__GROUP__/Comment/insert" name="form1" onsubmit=" return checkvalue(this)">
<p id="star">
  <label>
    <input type="radio" name="star" value="1" id="star_0" />
    <img src="__PUBLIC__/home_image/star1.gif" /></label>
  <label>
    <input type="radio" name="star" value="2" id="star_1" />
    <img src="__PUBLIC__/home_image/star2.gif" /></label>
  <label>
    <input type="radio" name="star" value="3" checked="checked" id="star_2" />
    <img src="__PUBLIC__/home_image/star3.gif" /></label>
  <label>
    <input type="radio" name="star" value="4" id="star_3" />
    <img src="__PUBLIC__/home_image/star4.gif" /></label>
  <label>
    <input type="radio" name="star" value="5" id="star_4" />
    <img src="__PUBLIC__/home_image/star5.gif" /></label>
</p>
<input type="hidden" name="pid" value="<?php echo ($vo["id"]); ?>">
<input type="hidden" name="module" value="trade" />
<div><textarea id="content" name="content" style="width:100%;" rows="5"></textarea></div>
<div class="cr"></div>
<p align="center"><input type="submit" value="提交评论" /></p>
</form>
<?php endif; ?>
