...
<script>
$("div#nav ul li:nth-child(5)").addClass("cc");
</script>
...
<?php  if(is_array($list)): foreach($list as $key=>$vo): ?><li>
	<p><span class="fr"><?php echo (toDate($vo["update_time"])); ?></span><a href="__APP__/News/show/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></p>
...
<div class="cr"></div>
<div class="box6-title">缤纷活动</div>
<ul class="list2">
<?php $_result=M('Huodong')->order('create_time desc')->where("1=1 and typeid = 1")->limit(8)->select(); if ($_result): $i=0;foreach($_result as $key=>$vo):++$i;$mod = ($i % 2 );?><li><a href="__GROUP__/Huodong/show/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif;?>
</ul>
    </div>
</div>
<div class="cr"></div>
