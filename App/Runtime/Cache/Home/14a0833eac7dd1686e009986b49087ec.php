...
<script>
$("ul.uilist li:nth-child(3) a").addClass("uc");
</script>
<div id="uinforight" class="box1">
<p class="titlen"><span></span></p>
<div class="box1-body">
<table border="0" cellspacing="0" cellpadding="0" class="tabs" align="center">
<tr><td colspan="4" align="center">积分记录<span id="allcc">(共<?php echo (getMyinfo($_SESSION['auth'],'score')); ?>点积分)</span></td></tr>
<tr><th width="39"></th><th width="96">积分</th><th>备注</th><th width="170">时间</th></tr>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr><td><?php echo ($i); ?></td><td><?php echo ($vo["point"]); ?></td><td width="219"><?php echo ($vo["why"]); ?></td><td><?php echo (date("Y-m-d H:i:s",$vo["log_time"])); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
<tr><td colspan="4" align="right"><?php echo ($page); ?></td></tr>
</table>
</div>
<p class="bottom"><span class="fl"></span><span class="fr"></span></p>
</div>
