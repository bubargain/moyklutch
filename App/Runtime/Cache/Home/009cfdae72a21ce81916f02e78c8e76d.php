...
<div class="box1 pda">
<ul class="list7">
<?php $_result=D('Ticket')->getlist("where ticket.status=1 and ticket.close_time > 1317216863 and ticket.trade_id =$vo[trade_id]",'order by ticket.id','10',''); if ($_result): $i=0;foreach($_result as $key=>$voo):++$i;$mod = ($i % 2 );?><li><a href="<?php echo ($voo["id"]); ?>"><?php echo (t_substr($voo["title"],0,14)); ?></a></li><?php endforeach; endif;?>
</ul>
</div>
<div class="cr"></div>
...
<div class="box1">
<ul class="list1">
<?php $_result=D('Ticket')->getlist("where ticket.status=1 and ticket.close_time > 1317216863",'','2',''); if ($_result): $i=0;foreach($_result as $key=>$vooo):++$i;$mod = ($i % 2 );?><li>
