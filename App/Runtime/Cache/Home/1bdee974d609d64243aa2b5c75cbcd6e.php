...
<div class="w96 ah">
	<div class="fl w71">
	<div class="box5-title">短消息管理</div>
<div class="ad1">
...
<script>
$("ul.uilist li:nth-child(5) a").addClass("uc");
</script>
...
<tr><td>发送人</td><td>发送时间</td><td>内容</td><td>删除</td></tr>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr><td><?php echo ($vo["msgfrom"]); ?></td><td><?php echo (date("Y-m-d H:i:s",$vo["dateline"])); ?></td><td><a href="__URL__/readmsg/msgid/<?php echo ($vo["pmid"]); ?>"><?php echo ($vo["subject"]); ?></a></td><td><a href="__URL__/delmsg/msgid/<?php echo ($vo["pmid"]); ?>">删除</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
</table>
共<?php echo ($count); ?>条未读消息
