...
<span class="fr">您当前选的分类是：<?php if($classname == ''): ?>全部<?php else: ?><?php echo ($classname); ?><?php endif; ?></span>
    ...
    <div id="jf-gp">
<a href="__URL__/elist">全部</a>
<?php if(is_array($classlist)): $i = 0; $__LIST__ = $classlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><a href="__URL__/elist/cid/<?php echo ($vo["id"]); ?>"
<?php if(($vo["id"])  ==  $_GET['cid']): ?>class="jfc"<?php endif; ?>
><?php echo ($vo["title"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
<div class="cr"></div>
<div class="msha-now ah"><form action="__URL__/elist" method="POST">
