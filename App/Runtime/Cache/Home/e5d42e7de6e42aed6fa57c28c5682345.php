...
<td><?php echo ($i); ?></td>
<td><a href="__GROUP__/Seckill/content/id/<?php echo ($vo["gid"]); ?>"><?php echo ($vo["title"]); ?></a></td>
<td><?php echo date('Y-m-d H:i:s',$vo[starttime]);?></td>
<td><?php echo (intval($vo[score]*$vo[failscore]/100)); ?></td>
<td>
<?php if(($vo["sectype"])  ==  "0"): ?><?php if($vo["endtime"] > time()): ?>等待秒杀
	<?php else: ?>
		秒杀失败<?php endif; ?><?php endif; ?>
<?php if(($vo["sectype"])  ==  "1"): ?><span style="color:red">成功待领取</span><?php endif; ?>
<?php if(($vo["sectype"])  ==  "2"): ?>已领取<?php endif; ?>
</td>
