...
<div class="w96 ah">
	<div class="fl w71">
	<div class="box5-title">绑定会员卡</div>
<div class="ad1">
...
<script>
$("ul.uilist li:nth-child(4) a").addClass("uc");
</script>
<div id="uinforight" class="box1">
<p class="titlen"><span></span></p>
<div class="box1-body">
<form id="form1" action="__APP__/Home/User/savebind" method="post" onSubmit="return Juge(this)">
<table class="infotable" border="0" cellspacing="0" cellpadding="0" align="center">
<?php if(empty($card_id)): ?><tr><td style="padding-left:40px;">请输入会员卡密码：<input name="card_password" type="password" id="" class="text" />
<?php if(!empty($error)): ?><span class="errmsg"><?php echo ($error); ?></span><?php endif; ?></td>
</tr>
<tr><td><span class="msginfo">注意哦，绑定会员卡，您可以额外得到奖励积分 <?php echo ($score_card); ?>,快点来参加</span></td></tr>
<tr><td align="center">
<input name="default_score" type="hidden" value="<?php echo ($score_card); ?>" />
<input type="submit" value="提&nbsp;交" /></td></tr>
<?php else: ?>
<tr><td>卡号</td><td>绑定时间</td><td>操作</td></tr>
<tr><td><?php echo ($card_id); ?></td><td><?php echo (date("Y-m-d H:i:s",$card_time)); ?></td><td><a href="__URL__/delbind">解绑</a></td></tr><?php endif; ?>
