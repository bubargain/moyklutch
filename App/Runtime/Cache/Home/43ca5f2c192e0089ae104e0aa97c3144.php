...
<div class="cr"></div>
<div class="fl w71">
<div id="space">当前位置：<a href="#">首页</a>&gt;优惠券详情&gt;<?php echo ($vo["title"]); ?></div>
	<div class="box">
<div id="qy">
	<div class="fl">
<p><span>名称：</span><?php echo ($vo["title"]); ?></p>
<p><span>编号：</span><?php echo ($vo["id"]); ?></p>
<p><span>商家：</span><a href="__GROUP__/Shop/show/id/<?php echo ($vo["trade_id"]); ?>"><?php echo (get_trade($vo["trade_id"])); ?></a></p>
<p><span>有效期至：</span><?php echo (toDate($vo["close_time"])); ?></p>
<p><span>类别：</span><?php echo (get_cate($vo["cate_id"])); ?></p>
<p id="qyt"><a href="__GROUP__/User/ticket_col/id/<?php echo ($vo["id"]); ?>">加入收藏</a>|<a href="#" onClick='copyToClipBoard()'>好友分享</a>|<a href="__GROUP__/Shop/show/id/<?php echo ($vo["trade_id"]); ?>">网友评分</a></p>
    </div>
    <div class="fr"><img src="__ROOT__/img/image/<?php echo ($vo["id"]); ?>.jpg" width="450" height="225" id="cov" /></div>
</div>
<div class="cr"></div>
<div class="box1-title">优惠券说明：</div>
<div class="box1 pda"><?php echo ($vo["content"]); ?></div>
<div class="cr"></div>
<p id="fpage"><a href="__GROUP__/Ticket/show/act/up/trade/<?php echo ($vo["trade_id"]); ?>/id/<?php echo ($vo["id"]); ?>">上一张</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="__GROUP__/Ticket/show/act/down/trade/<?php echo ($vo["trade_id"]); ?>/id/<?php echo ($vo["id"]); ?>">下一张</a>&nbsp;&nbsp;|&nbsp;&nbsp;共有优惠券<?php echo (get_ticketbytrade($vo["trade_id"])); ?>张</p>
<div class="cr"></div>
<div class="box5-title">其他优惠券：</div>
<div class="box1 pda">
<ul class="list7">
<?php $_result=D('Ticket')->getlist("where ticket.status=1 and ticket.close_time > 1352890284 and ticket.trade_id =$vo[trade_id]",'order by ticket.id','10',''); if ($_result): $i=0;foreach($_result as $key=>$voo):++$i;$mod = ($i % 2 );?><li><a href="<?php echo ($voo["id"]); ?>"><?php echo (t_substr($voo["title"],0,14)); ?></a></li><?php endforeach; endif;?>
</ul>
</div>
<div class="cr"></div>
<div class="box5-title">您可能感兴趣的优惠券</div>
<div class="box1">
<ul class="list1">
<?php $_result=D('Ticket')->getlist("where ticket.status=1 and ticket.close_time > 1352890284",'','2',''); if ($_result): $i=0;foreach($_result as $key=>$vooo):++$i;$mod = ($i % 2 );?><li>
...
<div class="fr">
<p class="q-name"><?php echo (get_trade($vo["trade_id"])); ?></p>
<p class="q-inf"><?php echo (t_substr($vo["title"],0,10)); ?></p>
<p class="q-pr">
