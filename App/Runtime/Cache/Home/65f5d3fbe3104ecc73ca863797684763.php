...
<div class="cr"></div>
<div class="msha-now">
	<p class="title"><span>网络速度：<label>快</label><a href="#"></a></span>正在秒杀商品</p>
    <div class="cr"></div>
    <ul class="listms1 ah">
<?php if(is_array($flist)): $i = 0; $__LIST__ = $flist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$f): ++$i;$mod = ($i % 2 )?><li>
	<p class="msha-ct"><a href="__URL__/content/id/<?php echo ($f["id"]); ?>"><?php echo ($f["title"]); ?></a></p>
    <p><span class="fr ms1">￥<?php echo ($f["price"]); ?></span>市场价格：</p>
    <p><span class="fr ms2">-<?php echo ($f["score"]); ?></span>所需积分：</p>
    <p class="msha-ct"><img src="<?php echo ($f["thumpath"]); ?>" width="168" height="118" /></p>
    <p><span class="fr ms3"><?php echo (date("H:i:s",$f["starttime"])); ?></span>开始时间：</p>
	<p><span class="fr ms4"><?php echo (date("H:i:s",$f["endtime"])); ?></span>结束时间：</p>
    <p class="msha-ct">
	<a href="__URL__/content/id/<?php echo ($f["id"]); ?>">
	立 刻 秒 杀
	</a>
	</p>
...
<div class="cr"></div>
<div class="msha-now">
	<p class="title"><span><a href="__URL__/slist">更多</a></span>待秒杀商品</p>
    <div class="cr"></div>
    <ul class="listms2 ah">
	<?php if(is_array($slist)): $i = 0; $__LIST__ = $slist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): ++$i;$mod = ($i % 2 )?><li>
	<p class="msha-ct"><a href="__URL__/content/id/<?php echo ($s["id"]); ?>"><?php echo ($s["title"]); ?></a></p>
...
<div class="cr"></div>
<div class="msha-now ah">
	<p class="title"><span><a href="__URL__/elist">更多</a></span>最新秒杀成功商品</p>
	<?php if(is_array($elist)): $i = 0; $__LIST__ = $elist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$e): ++$i;$mod = ($i % 2 )?><ul class="listms3">
<li class="ms3-1"><img src="<?php echo ($e["thumpath"]); ?>" width="110" height="110" /></li>
<li class="ms3-2">
	<p><a href="__URL__/content/id/<?php echo ($e["id"]); ?>"><?php echo ($e["title"]); ?> [已秒杀]</a></p>
    <div><?php echo (mb_substr(strip_tags($e["content"]),0,255,'utf-8')); ?></div>
</li>
<li class="ms3-3">
	<p>市场价格：<span class="fr ms1"><?php echo ($e["price"]); ?></span></p>
    <p>所需积分：<?php echo ($e["score"]); ?></p>
</li>
<li class="ms3-4">
	<p>恭 喜</p>
    <p><?php echo (get_succeeduser($e["id"])); ?></p>
    <p>秒杀成功</p>
</li>
