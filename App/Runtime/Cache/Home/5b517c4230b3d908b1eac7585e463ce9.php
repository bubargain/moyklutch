...
<p class="bottom"><span class="fl"></span><span class="fr"></span></p>
	...
	<script>
$("ul.uilist li:nth-child(2) a").addClass("uc");
</script>
	<div class="cr"></div>
	<div class="box1-title">我的收藏</div>
<div class="ad1">
<div id="uinforight" class="box1">
<p class="titlen"><span></span></p>
<div class="box1-body">
<table class="tabs" border="0" cellspacing="0" cellpadding="0" align="center">
<tr><th  width="240">优惠券</th><th width="270">有效期</th><th width="40">操作</th></tr>
<?php  if(is_array($list)): foreach($list as $key=>$vo): ?><tr><td><a href="__GROUP__/Ticket/show/id/<?php echo ($vo["ticket_id"]); ?>"><?php echo (get_ticket($vo["ticket_id"])); ?></a></td><td><?php echo (date("Y年-m月-d日",$vo["start_time"])); ?>——<?php echo (date("Y年-m月-d日",$vo["close_time"])); ?></td><td><a href="__GROUP__/User/del/module/ticket/id/<?php echo ($vo["id"]); ?>">删除</a></td></tr><?php endforeach; endif; ?>
</table>
</div>
<p class="bottom"><span class="fl"></span><span class="fr"></span></p>
</div>
