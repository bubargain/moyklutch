...
<td class="tLeft" ><select name="cid" >
  ...
  <?php echo get_newlist(); ?>
</select></td>


<td width="140">标签：
  <input type="text" name="tags" title="标签" size="8" value="<?php echo ($tags); ?>" ></td>
<td width="140">状态：
  <select name="status">
...
<td>更新时间：
  <input type="text" name="time1" size="10" onFocus="ShowCalendar(this)" value="<?php echo ($time1); ?>">~<input type="text" name="time2" size="10" onFocus="ShowCalendar(this)" value="<?php echo ($time2); ?>">
...
<th width="400"><a href="javascript:sortBy('title','<?php echo ($sort); ?>','index')">标题</a></th>
<th width="50"><a href="javascript:sortBy('stitle','<?php echo ($sort); ?>','index')">副标题</a></th>
<th width="200"><a href="javascript:sortBy('cid','<?php echo ($sort); ?>','index')">新闻类别</a></th>
<th width="100"><a href="javascript:sortBy('author','<?php echo ($sort); ?>','index')">作者</a></th>
<th width="200"><a href="javascript:sortBy('tags','<?php echo ($sort); ?>','index')">标签</a></th>
<th width="80"><a href="javascript:sortBy('count_num','<?php echo ($sort); ?>','index')">浏览量</a></th>
...
<td><?php echo (get_tag($vo["tags"])); ?></td>
<td><?php echo ($vo["count_num"]); ?></td>
