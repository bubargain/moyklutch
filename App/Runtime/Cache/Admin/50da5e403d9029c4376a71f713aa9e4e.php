...
<th width="78"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')">ID</a></th><th width="181"><a href="javascript:sortBy('trade_id','<?php echo ($sort); ?>','index')">商家</a></th><th width="183"><a href="javascript:sortBy('ticket_id','<?php echo ($sort); ?>','index')">优惠券</a></th><th width="361"><a href="javascript:sortBy('user_id','<?php echo ($sort); ?>','index')">用户</a></th><th width="183"><a href="javascript:sortBy('money','<?php echo ($sort); ?>','index')">结算额</a></th><th width="202"><a href="javascript:sortBy('create_time','<?php echo ($sort); ?>','index')">记录时间</a></th></tr>
