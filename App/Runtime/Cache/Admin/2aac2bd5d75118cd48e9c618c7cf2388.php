...
<th width="78"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')">ID</a></th><th width="181"><a href="javascript:sortBy('source','<?php echo ($sort); ?>','index')">用户</a></th><th width="183">操作</th><th width="361"><a href="javascript:sortBy('point','<?php echo ($sort); ?>','index')">操作积分</a></th><th width="202"><a href="javascript:sortBy('log_time','<?php echo ($sort); ?>','index')">记录时间</a></th></tr>
