...
<td width="203">活动类型：
  ...
  <option <?php if(($typeid)  ==  "1"): ?>selected<?php endif; ?> value="1">试用派发</option>
  <option <?php if(($typeid)  ==  "0"): ?>selected<?php endif; ?> value="0">精彩活动</option>
</select></td>
  <td width="767"><input type="submit" value="查询" class="small hMargin shadow submit"></td></tr></form>
</table>
</div>
</div>
<!-- 功能操作区域结束 -->
...
<th width="250"><a href="javascript:sortBy('title','<?php echo ($sort); ?>','index')">标题</a></th>
<th width="200"><a href="javascript:sortBy('typeid','<?php echo ($sort); ?>','index')">活动类型</a></th>
<th width="100"><a href="javascript:sortBy('start_time','<?php echo ($sort); ?>','index')">开始时间</a></th>
<th width="100"><a href="javascript:sortBy('close_time','<?php echo ($sort); ?>','index')">结束时间</a></th>
...
<td><?php if(($vo["typeid"])  ==  "0"): ?>精彩活动<?php endif; ?><?php if(($vo["typeid"])  ==  "1"): ?>试用派发<?php endif; ?></td>
<td><?php echo (toDate($vo["start_time"])); ?></td>
<td><?php echo (toDate($vo["close_time"])); ?></td>
