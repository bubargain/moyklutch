...
<td width="349">更新时间：
  <input type="text" name="time1" size="10" value="<?php echo ($time1); ?>">~<input type="text" name="time2" size="10" value="<?php echo ($time2); ?>"></td>
...
<th width="100"><a href="javascript:sortBy('create_time','<?php echo ($sort); ?>','index')">更新时间</a></th>
<th width="110">操作</th>
</tr>
