...
<th width="97"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')">ID</a></th>
<th width="329"><a href="javascript:sortBy('ticket_id','<?php echo ($sort); ?>','index')">优惠券</a></th>
<th width="353"><a href="javascript:sortBy('user_id','<?php echo ($sort); ?>','index')">用户</a></th>
<th width="328"><a href="javascript:sortBy('printdate','<?php echo ($sort); ?>','index')">打印时间</a></th>
</tr>
