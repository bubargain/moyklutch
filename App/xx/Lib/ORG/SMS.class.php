...
class SMS {
     ...
     * 网关地址
     */
    public $gwUrl = 'http://sdkhttp.eucp.b2m.cn/sdk/SDKService';
    /**
     * 序列号,请通过亿美销售人员获取
     */
    public $serialNumber = '0SDK-EMY-0130-LIVNM';
    /**
     * 密码,请通过亿美销售人员获取
     */
    public $password = '582092';
	    /**
     * 电话号码
     */
    public $number = array('13472860158');
    /**
     * 短信内容
     */
    public $news = 'test';
     ...
     * 短信发送 用例
     */
    function sendSMS($username,$password,$num=array(),$content) {
		$this->serialNumber = $username;
         ...
         */
        //$statusCode = $this->client->sendSMS(array('159xxxxxxxx','159xxxxxxxx'),"test2测试");
        $this->statusCode = $this->client->sendSMS($this->number, $this->news); //18627092724
        //echo "处理状态码:" . $this->statusCode;
        return $this->statusCode?false:true;
    }
    /**
     * 登录 用例
     */
    ...
    function logout() {
        ...
        $this->statusCode = $this->client->logout();
        echo "处理状态码:" . $this->statusCode;
    }
    ...
    function cancelMOForward() {
        ...
        $this->statusCode = $this->client->cancelMOForward();
        echo "处理状态码:" . $this->statusCode;
    }
    ...
    function chargeUp() {
        ...
        $cardPass = '123456';
        $this->statusCode = $this->client->chargeUp($cardId, $cardPass);
        echo "处理状态码:" . $this->statusCode;
    }
    ...
    function registDetailInfo() {
         ...
         *
         */
        $this->statusCode = $this->client->registDetailInfo($eName, $linkMan, $phoneNum, $mobile, $email, $fax, $address, $postcode);
        echo "处理状态码:" . $this->statusCode;
    }
    ...
    function updatePassword() {
         ...
         */
        $this->statusCode = $this->client->updatePassword('654321');
        echo "处理状态码:" . $this->statusCode;
    }
    ...
    function setMOForward() {
         ...
         */
        $this->statusCode = $this->client->setMOForward('159xxxxxxxx');
        echo "处理状态码:" . $this->statusCode;
    }
    ...
    function setMOForwardEx() {
         ...
         * 以数组形式填写手机号码
         */
        $this->statusCode = $this->client->setMOForwardEx(
                        $this->number
        );
        echo "处理状态码:" . $this->statusCode;
    }
